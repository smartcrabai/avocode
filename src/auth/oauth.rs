...
///
/// # Errors
/// Returns `AuthError` if the HTTP request fails or the response is missing required fields.
...
///
/// # Errors
/// Returns `AuthError::Timeout` on expiry, `AuthError::Rejected` on denial, or HTTP errors.
